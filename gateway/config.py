...
# Claude Code CLI bridge provider config — bridge-owned, see
# gateway/claude_bridge/__init__.py for the fork-maintenance rules.
from gateway.claude_bridge.config import (
    CLAUDE_PERMISSION_MODES,
    DEFAULT_CLAUDE_PERMISSION_MODE,
    ClaudeBridgeConfig,
    extract_claude_bridge_section,
)
...
def load_gateway_config() -> GatewayConfig:
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            claude_bridge_cfg = extract_claude_bridge_section(yaml_cfg, gateway_cfg)
